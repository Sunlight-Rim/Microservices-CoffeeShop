...
// 	protoc        v3.12.4
// source: internal/orders/grpc/proto/http.proto
...
func (x *Http) Reset() {
	*x = Http{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_orders_grpc_proto_http_proto_msgTypes[0]
...
func (*Http) Descriptor() ([]byte, []int) {
	return file_internal_orders_grpc_proto_http_proto_rawDescGZIP(), []int{0}
}
...
func (x *HttpRule) Reset() {
	*x = HttpRule{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_orders_grpc_proto_http_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HttpRule) Descriptor() ([]byte, []int) {
	return file_internal_orders_grpc_proto_http_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomHttpPattern) Reset() {
	*x = CustomHttpPattern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_orders_grpc_proto_http_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomHttpPattern) Descriptor() ([]byte, []int) {
	return file_internal_orders_grpc_proto_http_proto_rawDescGZIP(), []int{2}
}
...
var File_internal_orders_grpc_proto_http_proto protoreflect.FileDescriptor

var file_internal_orders_grpc_proto_http_proto_rawDesc = []byte{
	0x0a, 0x25, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x73, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x74, 0x74,
...
var (
	file_internal_orders_grpc_proto_http_proto_rawDescOnce sync.Once
	file_internal_orders_grpc_proto_http_proto_rawDescData = file_internal_orders_grpc_proto_http_proto_rawDesc
)

func file_internal_orders_grpc_proto_http_proto_rawDescGZIP() []byte {
	file_internal_orders_grpc_proto_http_proto_rawDescOnce.Do(func() {
		file_internal_orders_grpc_proto_http_proto_rawDescData = protoimpl.X.CompressGZIP(file_internal_orders_grpc_proto_http_proto_rawDescData)
	})
	return file_internal_orders_grpc_proto_http_proto_rawDescData
}

var file_internal_orders_grpc_proto_http_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_orders_grpc_proto_http_proto_goTypes = []interface{}{
	(*Http)(nil),              // 0: google.api.Http
	(*HttpRule)(nil),          // 1: google.api.HttpRule
	(*CustomHttpPattern)(nil), // 2: google.api.CustomHttpPattern
}
var file_internal_orders_grpc_proto_http_proto_depIdxs = []int32{
...
func init() { file_internal_orders_grpc_proto_http_proto_init() }
func file_internal_orders_grpc_proto_http_proto_init() {
	if File_internal_orders_grpc_proto_http_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_internal_orders_grpc_proto_http_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Http); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_orders_grpc_proto_http_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_orders_grpc_proto_http_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_internal_orders_grpc_proto_http_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*HttpRule_Get)(nil),
		(*HttpRule_Put)(nil),
		(*HttpRule_Post)(nil),
		(*HttpRule_Delete)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_internal_orders_grpc_proto_http_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_orders_grpc_proto_http_proto_goTypes,
		DependencyIndexes: file_internal_orders_grpc_proto_http_proto_depIdxs,
		MessageInfos:      file_internal_orders_grpc_proto_http_proto_msgTypes,
	}.Build()
	File_internal_orders_grpc_proto_http_proto = out.File
	file_internal_orders_grpc_proto_http_proto_rawDesc = nil
	file_internal_orders_grpc_proto_http_proto_goTypes = nil
	file_internal_orders_grpc_proto_http_proto_depIdxs = nil
}
